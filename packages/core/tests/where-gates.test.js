...
test('each gate lets through exactly what it says', () => {
  ...
  assert.equal(passesStaff({ name: 'A', crewShowCount: 2, keyShowCount: 1 }, { min: 3, keyMin: 2 }), false)
  assert.equal(passesStaff({ name: 'A', crewShowCount: 3, keyShowCount: 0 }, { min: 3, keyMin: 2 }), true)
  assert.equal(passesStaff({ name: 'A', crewShowCount: 2, keyShowCount: 2 }, { min: 3, keyMin: 2 }), true)
  assert.equal(passesStaff({ name: '', crewShowCount: 9, keyShowCount: 9 }, { min: 3, keyMin: 2 }), false)
